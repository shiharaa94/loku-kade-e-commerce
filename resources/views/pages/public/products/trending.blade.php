...
@section('title', 'Trending Products - Loku Kade')
...
<style>
    .trending-page-wrapper {
     ...
     @media (max-width: 767.98px) {
        .trending-page-wrapper { margin-top: 100px !important; padding-bottom: 2rem; }
     }
     .trending-title-area {
        text-align: center;
        margin-bottom: 2.5rem;
        padding: 3.5rem 1.5rem;
        background: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.45)), url('{{ asset('assets/images/trending_banner.webp') }}') no-repeat center center;
...
<div class="trending-page-wrapper">
    <div class="container">
        ...
        <div class="shop-banner-container mb-4">
            ...
            <img src="{{ asset('assets/images/trending_banner.webp') }}" alt="Loku Kade Trending Banner" class="shop-banner-img rounded">
        </div>

        @if(empty($products) || count($products) === 0)
            <div class="text-center py-5">
                <i class="bi bi-emoji-frown fs-1 text-muted d-block mb-3"></i>
                <h3 class="fw-bold">No trending products available</h3>
                <p class="text-muted">Place orders to build sales volume analytics!</p>
                <a href="{{ route('products.shop') }}" class="btn btn-primary mt-3 px-4 py-2" style="border-radius: 8px; font-weight: 600; font-family: 'Space Grotesk', sans-serif;">Go to Catalog</a>
            </div>
        @else
            <!-- Products Grid -->
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-rating d-flex align-items-center gap-2 mt-1 mb-2" style="font-size: 0.78rem; color: #6b7280; flex-wrap: wrap;">
                                @if(($product['sales_volume'] ?? 0) > 0)
                                    <span class="fw-bold" style="background: #e0f2fe; color: #0369a1; padding: 2px 6px; border-radius: 4px;">{{ $product['sales_volume'] }} sold</span>
