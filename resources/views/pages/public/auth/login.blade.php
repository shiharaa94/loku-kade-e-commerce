     ...
     <div class="container">
         <div class="auth-card">
             <div class="auth-header">
                 <h1>Sign In</h1>
                 <p style="margin-bottom:0;">Access your Loku Kade account</p>
             </div>
             ...
             <form action="{{ route('login') }}" method="POST">
                 ...
                 <div class="form-group">
                     <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem;">
                         ...
                         <a href="{{ route('password.request') }}" style="font-size: 0.8rem; color: #dc2626; text-decoration: none; font-weight: 500;">Forgot password?</a>
                     </div>
                 ...
                 <div class="form-group" style="display: flex; align-items: center; gap: 8px;">
                     ...
                     <label for="remember" style="font-size: 0.88rem; color: #4b5563; cursor: pointer; user-select: none;">Remember me</label>
                 </div>
