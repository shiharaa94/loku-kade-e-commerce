...
<head>
    ...
    <title>කාලය ඉකුත් වී ඇත (419) - Loku Kade</title>
...
<div class="error-card">
    ...
    <h1>කාලය ඉකුත් වී ඇත</h1>
    <p class="desc-si">
        ඔබගේ Session එකේ වලංගු කාලය ඉකුත් වී ඇත. කරුණාකර පිටුව Refresh කර නැවත උත්සාහ කරන්න.
    </p>
    <p class="desc-en">
    ...
    <div class="btn-group-custom">
        <button onclick="window.location.reload()" class="btn-custom btn-primary-custom">
            <i class="bi bi-arrow-clockwise"></i> පිටුව Refresh කරන්න
        </button>
