...
<head>
    ...
    <title>තාක්ෂණික දෝෂයක් (500) - Loku Kade</title>
...
<div class="error-card">
    ...
    <h1>තාක්ෂණික දෝෂයක්</h1>
    <p class="desc-si">
        අපගේ සේවාදායකයේ (Server) සුළු තාක්ෂණික ගැටලුවක් මතුවී ඇත. අපගේ කාර්ය මණ්ඩලය මේ වනවිට එය නිරාකරණය කරමින් සිටී.
    </p>
    <p class="desc-en">
        Something went wrong on our end. We are actively working to fix the issue. Please try refreshing or check back soon.
    </p>

    <div class="btn-group-custom">
        <button onclick="window.location.reload()" class="btn-custom btn-primary-custom">
            <i class="bi bi-arrow-clockwise"></i> නැවත උත්සාහ කරන්න (Refresh)
        </button>
    ...
    <div class="help-note">
        ගැටලුව දිගටම පවතී නම්: <a href="https://wa.me/94706050500" target="_blank"><i class="bi bi-whatsapp"></i> WhatsApp සහය ලබාගන්න</a>
    </div>
</div>
